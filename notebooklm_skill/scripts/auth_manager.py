...
class AuthManager:
    ...
    def setup_auth(self, headless: bool = False, timeout_minutes: int = 10) -> bool:
        ...
        try:
            ...
            print(f"  [TIMER]  Waiting up to {timeout_minutes} minutes for login...")
            ...
            try:
                ...
                print(f"  [ERR] Authentication timeout: {e}")
                return False
    ...
    def _save_browser_state(self, context: BrowserContext):
        ...
        try:
            ...
            print(f"  [ERR] Failed to save browser state: {e}")
            raise
    ...
    def clear_auth(self) -> bool:
        ...
        try:
            ...
            print(f"  [ERR] Error clearing auth: {e}")
            return False
    ...
    def re_auth(self, headless: bool = False, timeout_minutes: int = 10) -> bool:
        ...
        Returns:
            True if successful
        """
        print("[RETRY] Starting re-authentication...")
    ...
    def validate_auth(self) -> bool:
        ...
        print("[CHECK] Validating authentication...")
        ...
        try:
            ...
            if "notebooklm.google.com" in page.url and "accounts.google.com" not in page.url:
                ...
                print("  [ERR] Authentication is invalid (redirected to login)")
                return False
...
def main():
    ...
    if args.command == 'setup':
        if auth.setup_auth(headless=args.headless, timeout_minutes=args.timeout):
            ...
            print("\n[ERR] Authentication setup failed")
            exit(1)
