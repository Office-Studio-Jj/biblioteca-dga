...
class NotebookLibrary:
        ...
        if self.library_file.exists():
            try:
                with open(self.library_file, 'r') as f:
                    ...
                    print(f"[LIB] Loaded library with {len(self.notebooks)} notebooks")
    ...
    def _save_library(self):
        ...
        try:
            ...
            print(f"[ERR] Error saving library: {e}")
...
def main():
    ...
    if args.command == 'add':
        ...
        if notebooks:
            ...
            print("[LIB] Library is empty. Add notebooks with: notebook_manager.py add")
