...
_PARES_ELEMENTO_APARATO = [
    ...
    {"elem_kw": ["pantalla celular", "pantalla para celular", "display celular", "screen celular",
...
_MAPA_PARTIDAS_RGI = {
    ...
    "8473": {
        "trigger": ["robot libreria cintas", "robot tape library", "robot quantum", "robot scalar",
                     "robot g2", "modulo robotico almacenamiento", "robot autoloader",
                     "brazo robotico libreria", "robot picker cintas", "robot de cintas magneticas"],
        "rgi": "RGI 1 + Nota 2 Seccion XVI",
        "notas_legales": [
            "Partida 84.73: partes y accesorios de maquinas de la partida 84.71",
            "Nota 2 Seccion XVI: modulos roboticos de librerias de cintas son PARTES de unidades de almacenamiento ADP (8471.70)",
            "NO clasificar en 8428.70 (robots industriales) — es componente integral de sistema ADP",
        ],
        "exclusiones_partida": ["8428 robots industriales (independientes, no componentes ADP)"],
        "criterio_subpartida": "8473.30.90 partes y accesorios de maquinas 84.71",
    },
    "8419": {
        "trigger": ["liofilizador", "freeze dryer", "liofilizacion", "secado por congelacion",
                     "freezer dryer", "lyophilizer", "secador sublimacion"],
        "rgi": "RGI 1",
        "notas_legales": [
            "Partida 84.19: aparatos para tratamiento de materias por cambio de temperatura",
            "Subpartida 8419.33: aparatos de liofilizacion, secado por pulverizacion (SA 7ma Enmienda)",
            "NO clasificar en 8419.89 (los demas) — existe subpartida especifica 8419.33",
        ],
        "exclusiones_partida": ["8419.89 (residual — solo si no encaja en 8419.33)"],
        "criterio_subpartida": "agricola=8419.33.10, demas=8419.33.90",
    },
    "8413": {
