...
def ask_gemini(question, notebook_id, _intento=1):
    ...
    if notebook_id == "biblioteca-de-nomenclaturas":
        ...
        refuerzo = (
            ...
            "\n11. PANTALLA/DISPLAY para celular = 8524 (modulo pantalla plana, SA 7ma Enmienda). "
            "NUNCA 8517.11 (eso es el telefono completo). Pantalla sola es PARTE, partida 85.24."
            ...
            "(parte de maquina ADP 8471). NUNCA 8428.70 (robots industriales independientes)."
